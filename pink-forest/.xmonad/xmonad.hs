...
--
myNormalBorderColor  = "#3F5E73"
myFocusedBorderColor = "#2C455B"
...
myProgramsToGSConfig = ["dolphin", "opera", "gimp", "whatsapp-nativefier", "kdeconnect-app", "gcolor2", "youtube-music-bin", "virtualbox","pavucontrol","lollypop","st -e htop","st -e cmus","st -e tmux -u","simplescreenrecorder", "firefox", "spectacle", "genymotion", "google-earth-pro"]
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    --mod shift mask
    , ((modm .|. shiftMask, xK_p     ), spawn "pcmanfm") -- launch file manager
    , ((modm .|. shiftMask, xK_t ), safeSpawn "telegram-desktop" []) --telegram desktop
    , ((modm .|. shiftMask, xK_m ), safeSpawn "megasync" []) --megasync
    , ((modm .|. shiftMask, xK_c ), spawn "scrot -q 100 '%Y-%m-%d-%H-%M-%s_$wx$h.png' -e 'mv $f ~/Pictures/Screenshots'") --take a screenshot
    , ((modm .|. shiftMask, xK_f ), spawn "scrot -s -e 'mv $f /home/svendeer/Pictures/Screenshots/'") --select area to take screenshot
    , ((modm .|. shiftMask, xK_b ), safeSpawn "netsurf" []) --netsurf browser
    , ((modm .|. shiftMask, xK_b ), safeSpawn "leafpad" []) --leafpad
    , ((modm .|. shiftMask, xK_a ), safeSpawn "atril" []) --atril pdf reader

    --mod controlmask
    , ((modm .|. controlMask, xK_e ), safeSpawn "com.microsoft.Edge" [])
    , ((modm .|. controlMask, xK_k ), safeSpawn "kdevelop" [])
    , ((modm .|. controlMask, xK_t ), safeSpawn "tor-browser" [])
    , ((modm .|. controlMask, xK_p ), safeSpawn "picom" [])
    , ((modm .|. controlMask, xK_l ), spawn "killall picom")
    , ((modm .|. controlMask, xK_c ), safeSpawn "code" [])
    , ((modm .|. controlMask, xK_s ), safeSpawn "subl" []) --sublime text
    , ((modm .|. controlMask, xK_w ), safeSpawn "nitrogen" [])
    , ((modm .|. controlMask, xK_a ), safeSpawn "whatsdesk" []) --whatsapp desktop

    --Brightness. Use cat //usr/include/X11/XF86keysym.h | rg Audio to get this codes
    , ((0            , 0x1008ff13), spawn "pactl set-sink-volume @DEFAULT_SINK@ +1%") --up 1%
    , ((0            , 0x1008ff11), spawn "pactl set-sink-volume @DEFAULT_SINK@ -1%") --down 1%
    , ((0            , 0x1008ff12), spawn "pactl set-sink-mute @DEFAULT_SINK@ toggle") --mute

    --Brightness. Use cat //usr/include/X11/XF86keysym.h | rg Brightness to get this codes
    , ((0            , 0x1008FF02), spawn "light -A 1") --up 1%
    , ((0            , 0x1008FF03), spawn "light -U 1") --down 1%
    ...
    , ((modm, xK_s), spawnSelected defaultGSConfig $ myProgramsToGSConfig)
    -- , ((modm, xK_g), goToSelected  $ defaultGSConfig myWinColorizer)
...
--    spawnOnce "setxkbmap dvorak es &"
    -- spawnOnce "trayer --edge top --align right --SetDockType true --SetPartialStrut true --expand true --width 15 --transparent true --alpha 0 --tint 0x283339 --height 20 --monitor 1 &"
              ...
              -- hooks, layouts
                ...
                logHook            = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP 
                    { ppOutput = \x -> hPutStrLn xmproc0 x                          -- xmobar on monitor 1
                                >> hPutStrLn xmproc1 x 
                    , ppCurrent = xmobarColor "#ffffff,#811433" "" . wrap " " " " . clickable          -- Current workspace
                    , ppVisible = xmobarColor "#ffffff,#C14E71" "" . wrap " " " " . clickable           -- Visible but not current workspace
                    , ppHidden  = xmobarColor "#ffffff,#450445" "" . wrap " " " " . clickable           -- Hidden workspaces
