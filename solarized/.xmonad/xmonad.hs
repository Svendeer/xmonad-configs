              ...
              -- hooks, layouts
                ...
                logHook            = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP 
                    { ppOutput = \x -> hPutStrLn xmproc0 x                          -- xmobar on monitor 1
                                >> hPutStrLn xmproc1 x 
                                -- >> hPutStrLn xmproc2 x 
                    , ppCurrent = xmobarColor "#002831,#eae3cb" "" . wrap " " " " . clickable          -- Current workspace
                    , ppVisible = xmobarColor "#eae3cb,#002831" "" . wrap " " " " . clickable           -- Visible but not current workspace
                    , ppHidden  = xmobarColor "#eae3cb,#002831" "" . wrap " " " " . clickable           -- Hidden workspaces
