...
--
myNormalBorderColor  = "#4F5275"
myFocusedBorderColor = "#4F5275"
...
scrotFull :: String
scrotFull = "scrot -q 100 '%Y-%m-%d-%H-%M-%s_$wx$h.png' -e 'mv $f ~/Pictures/Screenshots'"

scrotSelect :: String
scrotSelect  ="scrot -s '%Y-%m-%d-%H-%M-%s_$wx$h.png' -e 'mv $f /home/svendeer/Pictures/Screenshots/'"
...
--    , ((modm .|. controlMask, xK_f ), spawn (flameshot)) --select area to take screenshot
    ...
    , ((modm .|. controlMask, xK_a ), safeSpawn (whatsapp) []) --whatsapp desktop
...
--    spawnOnce "setxkbmap dvorak es &"
    spawnOnce "trayer --edge top --align right --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --monitor 0 --transparent false --alpha 0 --tint 0x282c34 --height 25% &"
              ...
              -- hooks, layouts
                ...
                logHook            = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP 
                    { ppOutput = \x -> hPutStrLn xmproc0 x                          -- xmobar on monitor 1
                                >> hPutStrLn xmproc1 x 
                                -- >> hPutStrLn xmproc2 x 
                    , ppCurrent = xmobarColor "#000000,#FEC2C2" "" . wrap " " " " . clickable          -- Current workspace
                    , ppVisible = xmobarColor "#FFFFFF,#364888" "" . wrap " " " " . clickable           -- Visible but not current workspace
                    , ppHidden  = xmobarColor "#FFFFFF,#364888" "" . wrap " " " " . clickable           -- Hidden workspaces
