              ...
              -- hooks, layouts
                ...
                logHook            = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP 
                    { ppOutput = \x -> hPutStrLn xmproc0 x                          -- xmobar on monitor 1
                                >> hPutStrLn xmproc1 x 
                    , ppCurrent = xmobarColor "#272C33,#E78287" "" . wrap " " " " . clickable          -- Current workspace
                    , ppVisible = xmobarColor "#FFFFFF,#2A2D40" "" . wrap " " " " . clickable           -- Visible but not current workspace
                    , ppHidden  = xmobarColor "#FFFFFF,#2A2D40" "" . wrap " " " " . clickable           -- Hidden workspaces
