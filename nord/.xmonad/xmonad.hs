...
--    spawnOnce "/home/svendeer/.xmonad/runTrayer.sh &"
    ...
    spawnOnce "python3 /home/svendeer/Documents/c0de/Python/RecordatorioActividad/Checker.py &"
    setWMName "haskellWM"
              ...
              -- hooks, layouts
                ...
                logHook            = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP 
                    { ppOutput = \x -> hPutStrLn xmproc0 x                          -- xmobar on monitor 1
                                >> hPutStrLn xmproc1 x 
                                -- >> hPutStrLn xmproc2 x 
                    , ppCurrent = xmobarColor "#BF616A,#2E3440" "" . wrap " " " " . clickable          -- Current workspace
                    , ppVisible = xmobarColor "#EBCB8B,#2E3440" "" . wrap " " " " . clickable           -- Visible but not current workspace
                    , ppHidden  = xmobarColor "#A3BE8C,#2E3440" "" . wrap " " " " . clickable           -- Hidden workspaces
                    , ppHiddenNoWindows = xmobarColor "#B48EAD,#2E3440" "" . wrap " " " " . clickable   -- Hidden workspaces (no windows)
